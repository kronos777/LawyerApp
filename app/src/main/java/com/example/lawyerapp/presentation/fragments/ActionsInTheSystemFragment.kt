...
import com.example.lawyerapp.presentation.adapter.ActionInSituationAdapter
...
class ActionsInTheSystemFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private lateinit var actionListAdapter: ActionInSituationAdapter

    private var _binding: FragmentActionInSystemBinding? = null
    private val binding: FragmentActionInSystemBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentActionInSystemBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listArrayAction: ArrayList<ActionSystemItem> = ArrayList()
        setupRecyclerView()
        listArrayAction.add(ActionSystemItem(0, "Вход в систему Судный день", "09.08.2022", "15:30", "IP 111.212.3.67"))
        listArrayAction.add(ActionSystemItem(1, "Выход из приложения Судный день", "09.08.2022", "16:30", "IP 111.212.3.67"))
        listArrayAction.add(ActionSystemItem(3, "Вход в систему Судный день", "09.08.2022", "17:30", "IP 111.212.3.67"))

        actionListAdapter.submitList(listArrayAction)
/*
...
/*
    ...
    private fun setupRecyclerView() {
       with(binding.rvActionList) {
            actionListAdapter = ActionInSituationAdapter()
    ...
    private fun setupClickListener() {
        actionListAdapter.onPaymentItemClickListener = {
