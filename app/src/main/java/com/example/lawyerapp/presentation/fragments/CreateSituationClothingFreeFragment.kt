...
class CreateSituationClothingFreeFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAutoS3Binding? = null
    private val binding: FragmentSituationAutoS3Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAutoS3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
     ...
     //   private const val TWO_FRAGMENT_STRING = "first_fragment_string"
        ...
        fun newInstanceStr(string: String): CreateSituationClothingFreeFragment {
            return CreateSituationClothingFreeFragment().apply {
