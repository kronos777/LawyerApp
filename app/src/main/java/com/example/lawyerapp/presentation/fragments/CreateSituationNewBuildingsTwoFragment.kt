...
class CreateSituationNewBuildingsTwoFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationNewBuildingsS2Binding? = null
    private val binding: FragmentSituationNewBuildingsS2Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationNewBuildingsS2Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      //  Toast.makeText(getActivity(), "this params"+ strFirstFragment, Toast.LENGTH_SHORT).show()
        ...
        binding.enterButton.setOnClickListener {
            ...
            launchFragment(CreateSituationNewBuidingsFreeFragment.newInstanceStr(strToFree))
        }
...
/*        fun newInstanceStudentId(studentId: Int): PaymentItemListFragment {
    ...
    companion object {
        ...
        fun newInstanceStr(str: String): CreateSituationNewBuildingsTwoFragment {
            return CreateSituationNewBuildingsTwoFragment().apply {
                arguments = Bundle().apply {
