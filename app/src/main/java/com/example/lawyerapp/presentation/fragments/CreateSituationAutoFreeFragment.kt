...
class CreateSituationAutoFreeFragment: Fragment() {
    ...
    companion object {
     ...
     //   private const val TWO_FRAGMENT_STRING = "first_fragment_string"
        ...
        fun newInstanceStr(string: String): CreateSituationAutoFreeFragment {
            return CreateSituationAutoFreeFragment().apply {
