...
class CreateSituationNewBuidingsFreeFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationNewBuidingsS3Binding? = null
    private val binding: FragmentSituationNewBuidingsS3Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationNewBuidingsS3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
     ...
     //   private const val TWO_FRAGMENT_STRING = "first_fragment_string"
        ...
        fun newInstanceStr(string: String): CreateSituationNewBuidingsFreeFragment {
            return CreateSituationNewBuidingsFreeFragment().apply {
