...
class CreateSituationClothingOneFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationClothingS1Binding? = null
    private val binding: FragmentSituationClothingS1Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationClothingS1Binding.inflate(inflater, container, false)
        return binding.root
    }
...
/*
        ...
        binding.enterButton.setOnClickListener {
            launchFragment(CreateSituationClothingTwoFragment.newInstanceStr(radioSelect))
        }
