...
class CreateSituationAppliancesOneFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAppliancesS1Binding? = null
    private val binding: FragmentSituationAppliancesS1Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAppliancesS1Binding.inflate(inflater, container, false)
        return binding.root
    }
...
/*
        ...
        binding.enterButton.setOnClickListener {
            launchFragment(CreateSituationAppliancesTwoFragment.newInstanceStr(radioSelect))
        }
