...
class CreateSituationMedicalServicesOneFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationMedicalServicesS1Binding? = null
    private val binding: FragmentSituationMedicalServicesS1Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationMedicalServicesS1Binding.inflate(inflater, container, false)
        return binding.root
    }
