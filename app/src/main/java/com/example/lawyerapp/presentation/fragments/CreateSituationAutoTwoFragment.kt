...
class CreateSituationAutoTwoFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAutoS2Binding? = null
    private val binding: FragmentSituationAutoS2Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAutoS2Binding.inflate(inflater, container, false)
        return binding.root
    }
...
/*        fun newInstanceStudentId(studentId: Int): PaymentItemListFragment {
    ...
    companion object {
        ...
        fun newInstanceStr(str: String): CreateSituationAutoTwoFragment {
            return CreateSituationAutoTwoFragment().apply {
                arguments = Bundle().apply {
