...
import com.example.lawyerapp.databinding.FragmentChangeUserPhoneBinding
...
class ChangeUserPhoneFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentChangeUserPhoneBinding? = null
    private val binding: FragmentChangeUserPhoneBinding
        get() = _binding ?: throw RuntimeException("FragmentChangeUserPhoneBinding == null")
    ...
    override fun onCreateView(
        ...
        _binding = FragmentChangeUserPhoneBinding.inflate(inflater, container, false)
        return binding.root
    }
