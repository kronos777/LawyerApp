...
class CreateSituationAutoOneFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAutoS1Binding? = null
    private val binding: FragmentSituationAutoS1Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAutoS1Binding.inflate(inflater, container, false)
        return binding.root
    }
