...
class CreateSituationAppliancesTwoFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAppliancesS2Binding? = null
    private val binding: FragmentSituationAppliancesS2Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAppliancesS2Binding.inflate(inflater, container, false)
        return binding.root
    }
...
/*        fun newInstanceStudentId(studentId: Int): PaymentItemListFragment {
    ...
    companion object {
        ...
        fun newInstanceStr(str: String): CreateSituationAppliancesTwoFragment {
            return CreateSituationAppliancesTwoFragment().apply {
                arguments = Bundle().apply {
