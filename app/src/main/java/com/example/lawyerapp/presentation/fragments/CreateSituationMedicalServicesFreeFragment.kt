...
class CreateSituationMedicalServicesFreeFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationMedicalServicesS3Binding? = null
    private val binding: FragmentSituationMedicalServicesS3Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationMedicalServicesS3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
     ...
     //   private const val TWO_FRAGMENT_STRING = "first_fragment_string"
        ...
        fun newInstanceStr(string: String): CreateSituationMedicalServicesFreeFragment {
            return CreateSituationMedicalServicesFreeFragment().apply {
