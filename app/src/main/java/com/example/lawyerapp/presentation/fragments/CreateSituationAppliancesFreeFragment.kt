...
class CreateSituationAppliancesFreeFragment: Fragment() {

    private lateinit var onEditingFinishedListener: OnEditingFinishedListener

    private var _binding: FragmentSituationAppliancesS3Binding? = null
    private val binding: FragmentSituationAppliancesS3Binding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSituationAppliancesS3Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
     ...
     //   private const val TWO_FRAGMENT_STRING = "first_fragment_string"
        ...
        fun newInstanceStr(string: String): CreateSituationAppliancesFreeFragment {
            return CreateSituationAppliancesFreeFragment().apply {
